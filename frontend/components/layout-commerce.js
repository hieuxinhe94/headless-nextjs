...
const LayoutCommerce = ({ children, categories, layout, color, page }) => {
  ...
  <>
                    ...
                    <div class="w-full">
                        <nav class="flex items-center justify-between navbar navbar-expand-lg">
                            <a className={ "mr-4 navbar-brand " + textColor} href="/">
                                ...
                                <CustomImage imageClass={""} image={layout.LogoImage} />
    ...
    <Footer footer={page?.attributes?.Footer} siteInfo={layout.SiteInfo} />
    <a href="#" class="back-to-top"><i class="lni lni-chevron-up"></i></a>
  </>)
}

export default LayoutCommerce
