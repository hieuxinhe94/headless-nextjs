...
const Hero = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
    ...
    class: "header-hero",
    style: {
      backgroundImage: `url(` + (0,api/* getStrapiURL */.p)() + ((_homepage$attributes$ = homepage.attributes.HeaderBgImage) === null || _homepage$attributes$ === void 0 ? void 0 : _homepage$attributes$.data.attributes.url) + `)`
    },
        ...
        children: /*#__PURE__*/jsx_runtime_.jsx("div", {
          ...
          children: /*#__PURE__*/jsx_runtime_.jsx("div", {
            ...
            children: /*#__PURE__*/jsx_runtime_.jsx("img", {
              src: (0,api/* getStrapiURL */.p)() + ((_homepage$attributes$2 = homepage.attributes.HeroCentralImage) === null || _homepage$attributes$2 === void 0 ? void 0 : _homepage$attributes$2.data.attributes.url),
              alt: "hero"
            })
          })
        })
...
async function getStaticProps() {
  ...
  const [homepageRes, articlesRes] = await Promise.all([(0,api/* fetchAPI */.I)("/homepage", {
    populate: {
      seo: {
        populate: "*"
      },
...
var __webpack_exports__ = __webpack_require__.X(0, [544,664,672,759], function() { return __webpack_exec__(8270); });
